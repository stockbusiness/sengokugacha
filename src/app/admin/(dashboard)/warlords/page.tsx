...
const SLOT_PROMPT: Record<Warlord["slot_type"], string> = {
  common:
    "素朴で落ち着いた表情、装飾は控えめな簡素な鎧を身につけ、槍や刀を構えて戦場に立つ、日本の戦国時代の足軽級の武将。背景にはうっすらと砂塵が舞う",
  mid: "貫禄のある鋭い眼光で、鎧に金の装飾を加え、武器を構えて躍動感のあるポーズをとる、日本の戦国時代の武将級の武将。背景には旗指物と土煙を配する",
  rare: "鋭い眼光で躍動感のあるポーズを取り、豪華な金の装飾の鎧をまとい、雷光・炎の粉塵・舞い散る花びらなど武将の気迫を表す演出エフェクトと、背景に家紋・城のシルエットを配した、日本の戦国時代の大名格の武将",
};
